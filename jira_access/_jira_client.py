...
import json
from typing import IO, TYPE_CHECKING, Mapping, Optional
...
class JiraClient:
    _DEFAULT_HEADERS: Mapping[str, str] = {"Accept": "application/json", "Content-Type": "application/json"}
    ...
    def _execute_http_get_request(
        self, api_action: str, params: Optional[Mapping[str, str]] = None, headers: Optional[Mapping[str, str]] = None
    ) -> JsonType:
        headers = headers or self._DEFAULT_HEADERS
        url = self._api_url + api_action
        r: requests.Response = requests.get(
            url, params=params, headers=headers, auth=self._auth, timeout=self._REQUEST_TIMEOUT_SEC
        )
    ...
    def _execute_http_get_streamed_request(
        self,
        api_action: str,
        ...
        *,
        ...
        url = self._api_url + api_action
        r: requests.Response = requests.get(
            url, params=params, headers=headers, auth=self._auth, timeout=self._REQUEST_TIMEOUT_SEC, stream=stream
        )
    ...
    def _execute_http_post_requests_from_json_file(
        self,
        json_file_path: str,
        api_action: str,
        params: Optional[Mapping[str, str]] = None,
    ...
    def _execute_http_post_request(
        self,
        data: Json | IO,
        api_action: str,
        params: Optional[Mapping[str, str]] = None,
        ...
        r: requests.Response = requests.post(
            url, params=params, data=payload, headers=headers, auth=self._auth, timeout=self._REQUEST_TIMEOUT_SEC
        )
    ...
    def _execute_http_put_requests_from_json_file(
        self,
        json_file_path: str,
        api_action: str,
        params: Optional[Mapping[str, str]] = None,
